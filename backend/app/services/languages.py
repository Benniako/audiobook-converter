...
LANGUAGES = {
    "en":  {"name": "English",         "native": "English",           "flag": "🇬🇧", "tts": ["kokoro", "chatterbox", "qwen3", "omnivoice", "cosyvoice", "openai"]},
    "es":  {"name": "Spanish",         "native": "Español",           "flag": "🇪🇸", "tts": ["kokoro", "chatterbox", "omnivoice", "cosyvoice", "openai"]},
    "fr":  {"name": "French",          "native": "Français",          "flag": "🇫🇷", "tts": ["kokoro", "chatterbox", "omnivoice", "cosyvoice", "openai"]},
    "de":  {"name": "German",          "native": "Deutsch",           "flag": "🇩🇪", "tts": ["chatterbox", "omnivoice", "cosyvoice", "openai"]},
    "it":  {"name": "Italian",         "native": "Italiano",          "flag": "🇮🇹", "tts": ["kokoro", "chatterbox", "omnivoice", "cosyvoice", "openai"]},
    "pt":  {"name": "Portuguese",      "native": "Português",         "flag": "🇵🇹", "tts": ["chatterbox", "omnivoice", "cosyvoice", "openai"]},
    "nl":  {"name": "Dutch",           "native": "Nederlands",        "flag": "🇳🇱", "tts": ["omnivoice", "openai"]},
    "ru":  {"name": "Russian",         "native": "Русский",           "flag": "🇷🇺", "tts": ["chatterbox", "omnivoice", "cosyvoice", "openai"]},
    "ja":  {"name": "Japanese",        "native": "日本語",             "flag": "🇯🇵", "tts": ["kokoro", "chatterbox", "qwen3", "omnivoice", "cosyvoice", "openai"]},
    "ko":  {"name": "Korean",          "native": "한국어",              "flag": "🇰🇷", "tts": ["chatterbox", "qwen3", "omnivoice", "cosyvoice", "openai"]},
    "zh":  {"name": "Chinese",         "native": "中文",               "flag": "🇨🇳", "tts": ["kokoro", "chatterbox", "qwen3", "omnivoice", "cosyvoice", "openai"]},
    "ar":  {"name": "Arabic",          "native": "العربية",            "flag": "🇸🇦", "tts": ["omnivoice", "openai"]},
    "hi":  {"name": "Hindi",           "native": "हिन्दी",             "flag": "🇮🇳", "tts": ["omnivoice", "openai"]},
    "pl":  {"name": "Polish",          "native": "Polski",            "flag": "🇵🇱", "tts": ["chatterbox", "omnivoice", "openai"]},
    "tr":  {"name": "Turkish",         "native": "Türkçe",            "flag": "🇹🇷", "tts": ["chatterbox", "omnivoice", "openai"]},
