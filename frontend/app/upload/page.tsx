...
const PROVIDERS = [
  { id: "kokoro", name: "Kokoro-82M", quality: "Good (8/10)", languages: "8", hardware: "CPU/Any GPU", license: "Apache-2.0", tier: "free", desc: "Lightweight model that runs on any hardware.", icon: Zap, color: "from-indigo-500 to-purple-600" },
  { id: "chatterbox", name: "Chatterbox Turbo", quality: "Excellent (9/10)", languages: "23", hardware: "GPU 4GB+", license: "MIT", tier: "pro", desc: "SOTA quality with zero-shot voice cloning.", icon: Sparkles, color: "from-emerald-500 to-teal-600" },
  { id: "qwen3", name: "Qwen3-TTS 1.7B", quality: "Excellent (9/10)", languages: "10", hardware: "GPU 4-8GB", license: "Apache-2.0", tier: "pro", desc: "97ms latency with instruction control.", icon: Cpu, color: "from-violet-500 to-fuchsia-600" },
  { id: "omnivoice", name: "OmniVoice", quality: "Very Good (8/10)", languages: "600+", hardware: "GPU (CUDA/MPS)", license: "Apache-2.0", tier: "pro", desc: "600+ languages, 40x real-time.", icon: Globe, color: "from-blue-500 to-cyan-600" },
  { id: "cosyvoice", name: "CosyVoice 300M", quality: "Excellent (9/10)", languages: "10", hardware: "GPU 8GB+", license: "Apache-2.0", tier: "pro", desc: "Instruction-controlled 150ms streaming.", icon: Sparkles, color: "from-rose-500 to-pink-600" },
  { id: "openai", name: "OpenAI TTS", quality: "Very Good (8/10)", languages: "6", hardware: "Cloud API", license: "Proprietary", tier: "pro", desc: "Cloud-based. Requires API key.", icon: Globe, color: "from-orange-500 to-red-600" },
];
      ...
      <main className="max-w-3xl mx-auto px-4 py-6 sm:py-8 space-y-6">
        ...
        <div className="card p-4 sm:p-5">
          ...
          <div className="grid gap-3">
            {[
              { icon: BookOpen, name: "EPUB", color: "text-indigo-600 bg-indigo-50 dark:bg-indigo-900/30", desc: "Standard ebook format with chapter metadata" },
              { icon: FileText, name: "PDF", color: "text-red-600 bg-red-50 dark:bg-red-900/30", desc: "Chapter detection via heading analysis" },
              { icon: File, name: "TXT", color: "text-amber-600 bg-amber-50 dark:bg-amber-900/30", desc: "Plain text with automatic chapter splitting" },
            ].map((f, i) => (
